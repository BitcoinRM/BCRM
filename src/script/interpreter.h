...
{
    FORKID_BCC = 0,
    FORKID_BCRM = 94, // Must be unique for our fork
};

static const int FORKID_IN_USE = FORKID_BCRM;
...
enum
{
    ...
    // Allow NON_FORKID in legacy tests and blocks under BCRM hard fork height
    //
