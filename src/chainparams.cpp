...
//        if (consensus.hashGenesisBlock != uint256S(MAIN_GENESIS_HASH) || genesis.hashMerkleRoot != uint256S(MAIN_MERKLE_ROOT)) MineGenesisBlock(genesis, *this);
        ...
        vSeeds.emplace_back("dnsseed1.bitcoinrm.org", true);
        vSeeds.emplace_back("dnsseed2.bitcoinrm.org", true);
        vSeeds.emplace_back("dnsseed3.bitcoinrm.org", true);
        vSeeds.emplace_back("dnsseed4.bitcoinrm.org", true);
        vSeeds.emplace_back("dnsseed5.bitcoinrm.org", true);
        vSeeds.emplace_back("dnsseed6.bitcoinrm.org", true);
        vSeeds.emplace_back("dnsseed7.bitcoinrm.org", true);
        vSeeds.emplace_back("dnsseed8.bitcoinrm.org", true);
        vSeeds.emplace_back("dnsseed9.bitcoinrm.org", true);
        vSeeds.emplace_back("dnsseed10.bitcoinrm.org", true);
        ...
        vFoundersRewardAddress1 = {
            "RLiyoVgXfdFwtKWx8apHcBgaZvUhWjshEr",
            "RWPU2xZmNYzdAMLP4QFJgUG1kVR8NGUF8w",
            "RC14omcf1wAaEsC9kFFAUx8qcwdjxspK2K",
            "RVNsbZQLn9Kec9Kk1ebMDNupAkC1aJDqgs",
            "RN3qqNPcLXSXxhQkBtuhEwDMqMEMBGxkGv",
            "RVf3Ziujr86YjVYSNpW1hc1cbKeWp131uP",
            "RWZUwnxgQ7BvsjMJQEpEPhFmi7S3nKDaeC",
            "RGZQitwTn3UfNBPKctaKXxCagx6vt62uZi",
            "RAv4cGATohvaYF6euWcTEfdZfyjuhLfNnz",
            "RHcw4GF2NwSVNrdpqpR7rFZUCXEZEQFU7A",
            "RKnUHTQAkCsCf9KvnXD7mujptTMToweD4P",
            "RP859axDLCS9T2VQvzXBmkeRpkJG7apa8H",
            "RHiMypFF9F2zbqk6CNqm6GTC4G1K11HfuV",
            "RMqBHMY4eSu379FVoyLaLW8Dje9WR4bHWA",
            "RR3ukjuU5xxjfUVFFbM3qUnREtSnun9CYb",
            "RJSE8fv38WpWgQ1dwHA5kZViXKLM1x4A2e",
            "RB1sMLfUqs2hoZsiesxPumTYZzhC3JLxBL",
            "RK2EFF3bPthFND2e8cmFgHrPzAWsrbTurX",
            "RNomFu4n54eanqvSP78h7yzp9N4JshP7yR",
            "RJfRAiaBoUv6K6AzjSQCG7os1zLdsZD63C",
            "RLHExT5AggAhudDQf3JsvXjeEGk63d9Def",
            "RTBMrhgoGYFSwy8LNHCnGdxJqn5uhotwEA",
            "RKcbehs95fxT49wd8qQ39UHoecpps1vEfe",
            "RCWhMkuR5QuZDM9iEE8Lu2eVuZqHZ8JVXW",
            "RBNHz2fxgdGKSALcpJHsZWWtxgP26sthzC",
            "REoWMYxHJSvqACECeu5AWZ3F43WywAa1D3",
            "RXkkPuGRRmPGfbV6FEUQrzyeu39TDAStcZ",
            "RPeXP8ZnHxheRri37TxMvWaPpejd9FJ8es",
            "RW1r75oNVPB1KdGuwZfaYUULtSWu5gL1F4",
            "RJEDNZnSHGQSVguMGCcd4QfZQvrmQGqUgk",
            "RGQxzruqtbbdoWz5ZsdXW9Jtd5S5UjnGcT",
            "RBSraDPdUkbbzNTUoVmA2fLPgcvmwKpnzi",
            "RLm2XwrPsYE9aeyknSKspLn8LbJbqcM6tA",
            "REzLFhBtM9HNu4J8GKrACV4x5HezzoUuCj",
            "RR7BianPnjpza22tJQ6wEEr7k6u1tw92DS",
            "RVwZ3fn6w1aJFyWXUEmNTqt63EdofSG8Z9",
            "RKBkCy9C4MCtxczRosxzaUdPdF7eXpbD1x",
            "RV9dR4oDZNMUFiZL8JCPYMouVo5pmfZ2LR",
            "RQKUv2DYTRfg8fcrLQck8xwwAEa6pg8ocB",
            "RNNcuubWbHjdge1cTEWRgjNyEVxLRFLT3y",
            "REhziA9SCJo2ALjtbqzUQGYe8DBvSJLdoe",
            "RNM6h63K5Fej2VfruGjc7RmeeqzuhdVxiy",
            "RCEMDyLGBksK3N2Yw9iK8qa6a5iKpPqBCa",
            "RLMjApjpsguZYvGdPYRzFba6nhbQQniVYu",
            "RLi9PHK6f7BnNPm6WtkmDY7vjqYzpHwUFS",
            "RK2YV6hA3i1Fkn9LuBQCJ595kWxmuee6dC",
            "RJyvVbiwYkJaZ8MQfZd5cU3JQwQ7JBu6A8",
            "R9nkghfop4JXgSkHH15TRfqP6fzzZXkPur",
            "RK8EWaE29ChzC76JWupu6GiT3353f8MR6b",
            "RUm5X1foAHPcZKpTwzenUDbrTMCduSk4ss",
            "RFB2vqaTLnRsawemsngt55CME7d9zpWjF3",
            "RQDgE1Fdnhw3A58q9MGfw3J3y8725uMyM2",
            "RPeBnbEC1DFuci17AzFXTDXm8BNn6sRiM3",
            "RX6nZfZABGeQS1UFwVSAYsxp7AvADKp31p",
            "R9QEktbqZDc4NJuR7K3tz7fgyFRZJFeDBK",
            "R9yhcXXh8VzDkD7Jx8jnPknEkE6NsMZ6XZ",
            "RBWUT5MXE8PQ1kupj4gZCvSGdCSzWpg77X",
            "RMMjrJUzwNf6pHPwxHnsDVnAXDj2o3sDac",
            "RH3J71Y8ZkH6jSfeZv47vjCtkREH7Grysv",
            "RPCesubsZxLuB6ZCDqe4Yx3bsHhDnnfE1D",
            "RXPV2SrKCRJERTYGSGaQ9Rk6dEdmmQLVzx",
            "RKGUbJ8nN9eCsxk3nQEaJHxPFBaJy4uPdp",
            "RDaUAmceK2UMLAdRUy4gyn3MjbR2hHYdGr",
            "RUTQZU3jF6paMWN6xCvNBbL1BLAMwJJ8v8",
            "RBCLtQp9W5f5mjPgMjGJ6gXBGUcg9FpzkB",
            "RUCihmNxQeqEnkXRzE8yz1XyCYmstDaSUz",
            "RWtbgJvVa5nghN9odA27bZCgu8pr94ng5H",
            "RA3NvAoeGHatfiYJWgwraSD6taDNrDFBea",
            "RMR3EoxHEJvrrp8xZydvBSjdnWwMSas4kM",
            "RC1U9J5myYWy3M1wC9Fj7g2MgMGyGdC8qx",
            "RNDxQ2rrnArtbq3PWXeQ1XrhPmfyX2rbFZ",
            "RWqijoohgtqhyd5Az8ZUeMpmHh1hrjnWw5",
            "RD3nDn5kejrASLvKAVC6DmijKubVY7iy5j",
            "RRGXZe6cCow3QPVZYsAba9UPY7UXBbXAn9",
            "RTz5mE3orV9tAbC599Cgio5TpA2vJfKExU",
            "RLwgFg2RiMT1ASWGLJhup1JbpWjYSPXQJw",
            "RQ5XqXbZCRkQuezXAVYookH1k6KpniCh1P",
            "RVqhyJfTDc3GxyXeiKepPX6iaL2NENjFqB",
            "RGdThipV3sKhNUKewBNQ3V5b3nb5djLuWk",
            "RY8QALNdcb6roqsHAiQvDPUhkrEAbon2ty",
            "RRjCT8FCMnjfNxRhHTAniyz7rmtthtAtBY",
            "RCKtT43KvF1VmQyXhsCT2PeXPpTcBxXxnx",
            "RT8obtYvw2AghX9W7vkcPpRpFH8nDnihiS",
            "RSVLL6qeZ4KuHgWo4fL6nQcbqtRKeeAeLp",
            "RW3PYbtC18u73v1cCaEc77S5KPjkdwV3q3",
            "RM4zZrYN29yVArtBjjKCCGqtz5KA7poAFU",
            "RSPCBFQxijz6yaGkBAVYTYjTKkSp5wbq8B",
            "RPNzsPqQ8JLwhTrDkUfXQSCsus6qBrETwd",
            "RUHyjyF2ziXZung6umgZJ4Bn4oSQrrx8Ke",
            "RPQcSKzEPTrS4FRg1aBzgMxFmPyPLA9vaA",
            "RXsPq1qSVTKukZZbsVvxccdzFHFXUNJYeJ",
            "RLiBak9rfkmN6WbdWTcY5TjreUJuCXP17o",
            "RPDuyCfb5BUn8kFKxaCDvYgDVac2v5GbKW",
            "RGpFbXso8Nvr2oLM9fLn7c94Fyo9m6o72v",
            "RN2NQmAKf9V2KLvZEZVeMbygaNJ5ZSdRFg",
            "RWJNJELSJxKdxsQsKZqhS5p3VRqDU4vw2S",
            "RD9DcSeanHb5yb7CKqsaSWeWjPqwmH8W9T",
            "RAAVX8RpuRZXCtP79VV5FEEByKpVR4uKkB",
            "RCBxVzXy9WUR47wQRzFbL2JMA5pSnwzqaK",
            "RAGEunECTxQCwnYJqH3cqJxba5GJCzcUnE",
        };
    }
};
...
//        if (consensus.hashGenesisBlock != uint256S(TEST_GENESIS_HASH) || genesis.hashMerkleRoot != uint256S(TEST_MERKLE_ROOT)) MineGenesisBlock(genesis, *this);
...
//        if (consensus.hashGenesisBlock != uint256S(REG_GENESIS_HASH) || genesis.hashMerkleRoot != uint256S(REG_MERKLE_ROOT)) MineGenesisBlock(genesis, *this);
...
// Start paying founders reward from the last founder's address
// Therefore, deduct BCRMHeightRegular again
// This means founders reward kicks in only from block 1+2*BCRMHeightRegular
    ...
    const int vFsize = vFoundersRewardAddress.size();
    const int vFsize1 = vFoundersRewardAddress1.size();

    // Calling function GetFoundersRewardScript reduced height. So real height is height + reduction
    int h = height + consensus.BCRMHeightRegular;

    if (h < 1282001) {
      assert(vFsize > 1);
      //if (vFsize == 1) return vFoundersRewardAddress[0];
      return vFoundersRewardAddress[block % vFsize];
    }
    else {
      assert(vFsize1 > 1);
      //if (vFsize1 == 1) return vFoundersRewardAddress1[0];
      return vFoundersRewardAddress1[block % vFsize1];
    }
}
