...
struct Params {
    ...
    int BIP66Height;
    /** Block height at which Bitcoin RM hard fork becomes active */
    int BCRMHeight;
    /** Limit MAX_FUTURE_BLOCK_TIME **/
    int64_t BCRMMaxFutureBlockTime;
    /** Premining blocks for Bitcoin RM hard fork **/
    int BCRMPremineWindow;
    /** Block height at which regular mining begins **/
    int BCRMHeightRegular;
    bool BCRMPremineEnforceWhitelist;
    ...
    int64_t nZawyLwmaAdjustedWeight;   // k
