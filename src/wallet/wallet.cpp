...
const char * DEFAULT_WALLET_DAT = "BCRM.imp";
const char * TESTNET_DEFAULT_WALLET_DAT = "testnetBCRM.imp";
const char * REGTEST_DEFAULT_WALLET_DAT = "regtestBCRM.imp";
...
std::string CWallet::GetWalletHelpString(bool showDebug)
{
    ...
    strUsage += HelpMessageOpt("-wallet=<file>", _("Specify wallet file (within data directory)") + " " + strprintf(_("(default: %s or %s or %s)"), DEFAULT_WALLET_DAT, TESTNET_DEFAULT_WALLET_DAT, REGTEST_DEFAULT_WALLET_DAT));
...
CWallet* CWallet::CreateWalletFromFile(const std::string walletFile)
{
    ...
    if (fFirstRun)
    {
        ...
        if (gArgs.GetBoolArg("-usehd", DEFAULT_USE_HD_WALLET) && !walletInstance->IsHDEnabled()) {
            ...
            // ensure this BCRM.imp can only be opened by clients supporting HD with chain split
...
bool CWallet::ParameterInteraction()
{
    if (gArgs.GetBoolArg("-testnet", false))
        gArgs.SoftSetArg("-wallet", TESTNET_DEFAULT_WALLET_DAT);
    else if (gArgs.GetBoolArg("-regtest", false))
        gArgs.SoftSetArg("-wallet", REGTEST_DEFAULT_WALLET_DAT);
    else
