...
public:
    ...
    std::string GetFoundersRewardAddress(uint32_t height) const;
    CScript GetFoundersRewardScript(uint32_t height) const;
protected:
    CChainParams() {}
    ...
    std::vector<std::string> vFoundersRewardAddress1;
};
