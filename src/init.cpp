...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-bootstrap", _("Enables Bitcoin RM bootstrap mode. Allows BCRM client to connect to Bitcoin p2p network to download blockahin history."));
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/BitcoinRM/BCRM>";
    const std::string URL_WEBSITE = "<https://www.bitcoinrm.org>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    fBCRMBootstrapping = gArgs.GetBoolArg("-bootstrap", false);
